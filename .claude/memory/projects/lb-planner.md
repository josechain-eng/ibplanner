...
- ⚠️ Fuente TC oficial = DolarAPI `bo.dolarapi.com` casa 'oficial' (campo venta). Estaba correcta (11.54); el problema era timing del cache, no la fuente. dolarboliviahoy.com sigue siendo JS-rendered (no scrapeable) — no se usa. Para arreglo inmediato del cache: `GET /dailyinfo?force=1`.
